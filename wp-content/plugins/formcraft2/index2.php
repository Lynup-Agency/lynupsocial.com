...
{
      echo "<h3 style='font-weight: 400; color: #666'>Please install / enable cURL on your PHP installation.<br>If you don't know how to do this, please contact your web host.</h3>";
      die();
}
...
wp_enqueue_style( 'facss', plugins_url( 'css/font-awesome/css/font-awesome.css', __FILE__ ));
...
wp_localize_script( 'form_index_js', 'MyAjax', array( 'ajaxurl' => admin_url( 'admin-ajax.php' ) ) );
...
// Load DataTables JS
wp_enqueue_script( 'data_tables', plugins_url( 'js/datatables.js', __FILE__ ));
...
<div class="ffcover_add">
	...
	<form class="modal hide fade" id='new_form' action='javascript:submit_new_form();' style='width: 640px'>
		...
		<div class="modal-body">
			...
			<label class='label_radio circle-ticked' style='margin-left: 22px'>
			...
			<select name='duplicate' style='height: 30px; max-width: 178px' id='rand_a'>
				...
				<label class='label_radio circle-ticked' style='margin-left: 36px' >
					<input type='radio' value='import' name='type_form' id='rand_b'><div class='label_div' style='background: #fff'>Import</div>
				</label>
				<a style='position: absolute; left: 113px; bottom: -19px; font-size: 11px;' href='http://ncrafts.net/formcraft/uncategorized/download-form-templates/' target='_blank'>get form templates</a>


				<span class='import btn btn-success fileupload-cover'>
					<input id="fileupload" class='import import_field fileupload' type="file" name="files[]" data-url="<?php echo plugins_url('formcraft/file-upload/server/php/'); ?>" multiple style='width: 84px; height: 24px; margin: 0px;'>
		...
		<ul class="nav nav-pills" style='margin-top: 60px'>
			...
			<li><a href="#submissions" id='stab' data-toggle="tab">Submissions <span style='color: green'>(<?php echo $totalSubAll-$totalSubSeen; ?>)</span></a></li>
				...
				<div class="tab-pane" id="forms">		
					...
					<div class="tab-pane" id="submissions">			
						...
						<div class="tab-pane" id="files">				
							...
							$url = plugins_url('formcraft/file-upload/server/php/');
