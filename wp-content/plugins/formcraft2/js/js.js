function save_form(build, option, con, rec)
{
  ...
  if (build.length+option.length+con.length+rec.length == window.content_len)
  {
...
jQuery('#stab').click(function(){
  ...
  // Update Submissions
  jQuery('body').on('click','.view_mess',function(){
