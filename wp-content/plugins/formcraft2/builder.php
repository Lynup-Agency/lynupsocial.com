				...
				<div class="main_builder">
					<div class='build_affix' data-spy="affix" data-offset-top="0"><!-- Start of affixed Part -->
						...
						<div class='head_holder'>
							<a class='sbtn' href='?page=survey_builder' style='width: 144px'><i class='icon-chevron-left icon-white'></i> Home Tab</a>
													...
													<div class='global_holder'>
														...
														<div class='op_{{con[0].formpage}}'>
															...
															<div class='well well-small code'>
																<?php echo plugins_url().'/formcraft/form.php?id='.$id; ?>
															</div>
														</div>
									...
									<div class="accordion-inner">
													...
													<div class="accordion-inner l2">
														...
														<div class='global_holder'>
															...
															<span class='btn-group ' data-toggle='buttons-radio'>
																...
																<button type='button' class='btn btn-primary <? echo $theme2; ?> tool' ng-click='con[0].bg_image="url(<?php echo plugins_url('formcraft/images/wash.png') ?>)"'>Linen</button>

																<button type='button' class='btn btn-primary <? echo $theme3; ?> tool' ng-click='con[0].bg_image="url(<?php echo plugins_url('formcraft/images/jean.png') ?>)"'>Jean</button>

																<button type='button' class='btn btn-primary <? echo $theme4; ?> tool' ng-click='con[0].bg_image="url(<?php echo plugins_url('formcraft/images/debut.png') ?>)"'>Debut</button>

																<button type='button' class='btn btn-primary <? echo $theme6; ?> tool' ng-click='con[0].bg_image="url(<?php echo plugins_url('formcraft/images/carbon.png') ?>)"'>Carbon</button>
															...
															<span class=''>
																...
																<input  class="btn btn-primary upload_logo_formpage_url" type="button" value="Select"/>
															</span>
										...
										<div class='choose_from_main'>
											...
											<span class='choose_from btn-group'>
												...
												<ul class="dropdown-menu">
													<li><a ng-click="addEl('time12')">TimePicker</a></li>
							...
							<td style='vertical-align: top'>
								<div class="preview_form">
									...
									<h4>You can <strong>drag</strong> and <strong>drop</strong> the fields to change their order.<br>Click to edit them.
										<a href='<?php echo plugins_url().'/formcraft/form.php?id='.$id.'&preview=true'; ?>' target='_blank'>Live Preview (new window)</a>
									</h4>
									<div class='html_here'><?php $form_id = "123$_GET[id]"; ?><form class="a_<?php echo $form_id; ?> nform bootstrap {{con[0].cl_hidden_fields}} {{con[0].user_save_form}} {{con[0].placeholder}} {{con[0].frame}} {{con[0].direction}} {{con[0].theme}} {{con[0].themev}} {{con[0].themef}} {{con[0].block_label}} star_{{con[0].show_star_validation}} {{con[0].flayout}}" action='javascript:submit_formcraft(<?php echo $form_id; ?>);' ng-style='{width: con[0].fw, borderRadius: con[0].fr+"px", MozBorderRadius: con[0].fr+"px", WebkitBorderRadius: con[0].fr+"px", fontFamily: con[0].formfamily, backgroundImage: con[0].bg_image, background: con[0].bg_transparent}' id='<?php echo $form_id; ?>'><input type='hidden' class='form_id' val='<?php echo $id; ?>' ng-model='con[0].form_main_id'><input type='hidden' class='getlocation' val='' name='location_hidden__0_0_1000_'><div id='fe_title' class='nform_li form_title {{con[0].theme}}' ng-style='{fontSize: con[0].ft_px+"px", borderTopLeftRadius: con[0].fr+"px", MozBorderTopLeftRadius: con[0].fr+"px", WebkitBorderTopLeftRadius: con[0].fr+"px", borderTopRightRadius: con[0].fr+"px", MozBorderTopRightRadius: con[0].fr+"px", WebkitBorderTopRightRadius: con[0].fr+"px", color: con[0].ft_co, backgroundColor: con[0].ft_bg, fontFamily: con[0].tfamily, fontWeight: con[0].tbold, backgroundImage: con[0].bg_image, background: con[0].bg_transparent, textAlign: con[0].ftalign}'>{{con[0].form_title}}</div><ul class='form_ul clearfix {{con[0].theme}}' id='form_ul'><li ng-repeat="el in build" ng-style='{paddingBottom: con[0].space+"px", paddingTop: con[0].space+"px"}' id='fe_{{$index}}_<?php echo $form_id; ?>' class='nform_li' ng-class='[el.default, el.inline, con[0].field_align, el.li_class, "fe_"+$index]' scale><div compile="el.el_f" ng-style='{marginBottom: el.divspa, marginTop: el.divspa}'></div><span class='element_id'>{{$index}}</span></ul><div id='fe_submit' class='form_submit' style='position: relative; display: block'><span style='text-align: center; display: inline-block; padding-top: 8px; padding-bottom: 4px'><a class='ref_link' ng-href='http://codecanyon.net/item/formcraft-premium-wordpress-form-builder/5335056?ref={{con[0].ruser}}' compile="con[0].rlink" target='_blank' title='Opens in a new tab'></a></span><div class='res_div'><span class='nform_res'></span></div></div></form>
								</div>
