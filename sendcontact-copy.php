...
define( "RECIPIENT_NAME", "Lynup Creative Social" ); //UPDATE THIS TO YOUR NAME
define( "RECIPIENT_EMAIL", "metamery.simon@origosoftware.com" ); //UPDATE THIS TO YOUR EMAIL ID
